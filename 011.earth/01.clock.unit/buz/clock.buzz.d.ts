...
export declare const blockClock: (cpy: ClockModel, bal: ClockBit, ste: State) => Promise<ClockModel>;
export declare const listClock: (cpy: ClockModel, bal: ClockBit, ste: State) => Promise<ClockModel>;
